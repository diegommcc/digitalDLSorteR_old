...
#'
#' Getter function for cell composition matrix. This function allows you
#' access to the cell composition matrix of train or test bulk data.
#'
...
#'
#' Show distribution plots of cell proportions generated by the five different methods
#' used by \code{\link{generateTrainAndTestBulkProbMatrix}}.
#' These frequencies will determine the proportion of different cell types
#' used during the simulation of bulk RNA-Seq samples. There are 6 subsets
#' of proportions (1 and 2 are generated by the same way) by different approaches
#' that can be shown with three types of visualizations: boxplot, violinplot and linesplot.
#' You also can represent the probabilities based on the number of
#' different cell types present in samples setting \code{type.plot = 'nMix'}.
#'
...
#'  distribution.
#' @param type.plot Character determining which type of visualization show.
