...
#' of cell types available in single-cell profiles), are randomly generated
...
#' available: approximately 18 more samples will be formed than there are
#' cells in \code{single.cell.final}. We recommend set a number of 30000
#' samples. This number will be split in training and test data: 60% for
#' training and 40% for evaluating the model.
#
...
#' for each cell type present in the experiment. This information can be
#' estimated from literature or from the single-cell experiment itself. This
...
#' 18 more samples will be formed than there are cells in
#' \code{single.cell.final} slot.
...
#' If it is equal to NULL (by default), all cell types will be mixed when
#' generating bulk samples.
