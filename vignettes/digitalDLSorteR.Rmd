...
abstract: |
  ...
  vignette, both ways of use are explained with data loaded into the package. 
vignette: |
...
The foundation of the method consists in a process that starts from scRNA-Seq 
...
that corresponds with cell types in cells metadata. Moreover, you can add cell covariates based 
...
However, the optimizier stage is not saved by these ways. In order to offer 
